...
class SampleResponseApi(object):
    ...
    async def get_cards_sample_response_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(IntegratorCardPayloadResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for key, val in six.iteritems(local_var_params["kwargs"]):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method get_cards_sample_response" % key)
