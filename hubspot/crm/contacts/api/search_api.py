...
class SearchApi(object):
    ...
    async def do_search(self, public_object_search_request, **kwargs):  # noqa: E501
        ...
        Search for contacts by filtering on properties, searching through associations, and sorting results. Learn more about [CRM search](https://developers.hubspot.com/docs/guides/api/crm/search#make-a-search-request).  # noqa: E501
