...
from hubspot.crm.exports.api_client import ApiClient
from hubspot.crm.exports.exceptions import ApiTypeError, ApiValueError  # noqa: F401


class PublicExportsApi(object):
    ...
    async def get_status(self, task_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_status(task_id, async_req=True)
        >>> result = thread.get()
    ...
    async def get_status_with_http_info(self, task_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_status_with_http_info(task_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ActionResponseWithSingleResultURI, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for key, val in six.iteritems(local_var_params["kwargs"]):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method get_status" % key)
            local_var_params[key] = val
        del local_var_params["kwargs"]
        # verify the required parameter 'task_id' is set
        if self.api_client.client_side_validation and local_var_params.get("task_id") is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `task_id` when calling `get_status`")  # noqa: E501
    ...
    async def start(self, public_export_request, **kwargs):  # noqa: E501
        ...
        >>> thread = api.start(public_export_request, async_req=True)
        >>> result = thread.get()

        :param public_export_request: (required)
        :type public_export_request: PublicExportRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
    ...
    async def start_with_http_info(self, public_export_request, **kwargs):  # noqa: E501
        ...
        >>> thread = api.start_with_http_info(public_export_request, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ["public_export_request"]
        all_params.extend(["async_req", "_return_http_data_only", "_preload_content", "_request_timeout", "_request_auth", "_content_type", "_headers"])

        for key, val in six.iteritems(local_var_params["kwargs"]):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method start" % key)
            local_var_params[key] = val
        del local_var_params["kwargs"]
        # verify the required parameter 'public_export_request' is set
        if self.api_client.client_side_validation and local_var_params.get("public_export_request") is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `public_export_request` when calling `start`")  # noqa: E501
        ...
        body_params = None
        if "public_export_request" in local_var_params:
            body_params = local_var_params["public_export_request"]
        # HTTP header `Accept`
        header_params["Accept"] = self.api_client.select_header_accept(["application/json", "*/*"])  # noqa: E501
