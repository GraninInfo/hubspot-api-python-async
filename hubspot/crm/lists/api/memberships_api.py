...
class MembershipsApi(object):
    ...
    def add_and_remove(self, list_id, membership_change_request, **kwargs):  # noqa: E501
        ...
        >>> thread = api.add_and_remove(list_id, membership_change_request, async_req=True)
        >>> result = thread.get()

        :param list_id: The **ILS ID** of the `MANUAL` or `SNAPSHOT` list. (required)
        :type list_id: str
        :param membership_change_request: (required)
    ...
    def add_and_remove_with_http_info(self, list_id, membership_change_request, **kwargs):  # noqa: E501
        ...
        >>> thread = api.add_and_remove_with_http_info(list_id, membership_change_request, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params["kwargs"]):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method add_and_remove" % key)
            local_var_params[key] = val
        del local_var_params["kwargs"]
        # verify the required parameter 'list_id' is set
        if self.api_client.client_side_validation and local_var_params.get("list_id") is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `list_id` when calling `add_and_remove`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and local_var_params.get("membership_change_request") is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `membership_change_request` when calling `add_and_remove`")  # noqa: E501
    ...
    def get_lists(self, object_type_id, record_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_lists(object_type_id, record_id, async_req=True)
        >>> result = thread.get()

        :param object_type_id: Object type id of the record (required)
        :type object_type_id: str
        :param record_id: Id of the record (required)
        :type record_id: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
    ...
    def get_lists_with_http_info(self, object_type_id, record_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_lists_with_http_info(object_type_id, record_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ApiCollectionResponseRecordListMembershipNoPaging, status_code(int), headers(HTTPHeaderDict))
        """

        local_var_params = locals()

        all_params = ["object_type_id", "record_id"]
        all_params.extend(["async_req", "_return_http_data_only", "_preload_content", "_request_timeout", "_request_auth", "_content_type", "_headers"])

        for key, val in six.iteritems(local_var_params["kwargs"]):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method get_lists" % key)
            local_var_params[key] = val
        del local_var_params["kwargs"]
        ...
        if self.api_client.client_side_validation and local_var_params.get("object_type_id") is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `object_type_id` when calling `get_lists`")  # noqa: E501
        # verify the required parameter 'record_id' is set
        if self.api_client.client_side_validation and local_var_params.get("record_id") is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `record_id` when calling `get_lists`")  # noqa: E501
    ...
    async def get_page_with_http_info(self, list_id, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ApiCollectionResponseJoinTimeAndRecordId, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def get_page_ordered_by_added_to_list_date(self, list_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_page_ordered_by_added_to_list_date(list_id, async_req=True)
        >>> result = thread.get()
    ...
    def get_page_ordered_by_added_to_list_date_with_http_info(self, list_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_page_ordered_by_added_to_list_date_with_http_info(list_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params["kwargs"]):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method get_page_ordered_by_added_to_list_date" % key)
            local_var_params[key] = val
        del local_var_params["kwargs"]
        # verify the required parameter 'list_id' is set
        if self.api_client.client_side_validation and local_var_params.get("list_id") is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `list_id` when calling `get_page_ordered_by_added_to_list_date`")  # noqa: E501
