...
class BatchApi(object):
    ...
    async def archive(self, batch_input_simple_public_object_id, **kwargs):  # noqa: E501
        """Archive a batch of calls by ID  # noqa: E501

        Archive a batch of calls by ID. Deleted calls can be restored within 90 days of being deleted, but call recordings recording will be permanently deleted. Learn more about [restoring activity records](https://knowledge.hubspot.com/records/restore-deleted-activity-in-a-record).  # noqa: E501
    ...
    async def create(self, batch_input_simple_public_object_batch_input_for_create, **kwargs):  # noqa: E501
        """Create a batch of calls  # noqa: E501

        Create a batch of calls. The `inputs` array can contain a `properties` object to define property values for each record, along with an `associations` array to define [associations](https://developers.hubspot.com/docs/guides/api/crm/associations/associations-v4) with other CRM records.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    async def read(self, batch_read_input_simple_public_object_id, **kwargs):  # noqa: E501
        """Read a batch of calls by internal ID, or unique property values  # noqa: E501

        Retrieve a batch of calls by ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    async def update(self, batch_input_simple_public_object_batch_input, **kwargs):  # noqa: E501
        """Update a batch of calls by internal ID, or unique property values  # noqa: E501

        Update a batch of calls by ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    async def upsert(self, batch_input_simple_public_object_batch_input_upsert, **kwargs):  # noqa: E501
        """Create or update a batch of calls by unique property values  # noqa: E501
