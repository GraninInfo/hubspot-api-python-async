...
from hubspot.crm.objects.communications.api_client import ApiClient
from hubspot.crm.objects.communications.exceptions import ApiTypeError, ApiValueError  # noqa: F401
...
class BasicApi(object):
    ...
    async def archive(self, communication_id, **kwargs):  # noqa: E501
        """Archive  # noqa: E501

        Move an Object identified by `{communicationId}` to the recycling bin.  # noqa: E501
        ...
        return await self.archive_with_http_info(communication_id, **kwargs)  # noqa: E501

    async def archive_with_http_info(self, communication_id, **kwargs):  # noqa: E501
        """Archive  # noqa: E501
        ...
        if self.api_client.client_side_validation and local_var_params.get("communication_id") is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `communication_id` when calling `archive`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if "communication_id" in local_var_params:
            path_params["communicationId"] = local_var_params["communication_id"]  # noqa: E501
    ...
    async def get_by_id(self, communication_id, **kwargs):  # noqa: E501
        """Read  # noqa: E501

        Read an Object identified by `{communicationId}`. `{communicationId}` refers to the internal object ID by default, or optionally any unique property value as specified by the `idProperty` query param.  Control what is returned via the `properties` query param.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        """
        kwargs["_return_http_data_only"] = True
        return await self.get_by_id_with_http_info(communication_id, **kwargs)  # noqa: E501

    async def get_by_id_with_http_info(self, communication_id, **kwargs):  # noqa: E501
        """Read  # noqa: E501
        ...
        all_params = ["communication_id", "properties", "properties_with_history", "associations", "archived", "id_property"]
        all_params.extend(["async_req", "_return_http_data_only", "_preload_content", "_request_timeout", "_request_auth", "_content_type", "_headers"])
        ...
        # verify the required parameter 'communication_id' is set
        if self.api_client.client_side_validation and local_var_params.get("communication_id") is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `communication_id` when calling `get_by_id`")  # noqa: E501
    ...
    async def update(self, communication_id, simple_public_object_input, **kwargs):  # noqa: E501
        """Update  # noqa: E501
        ...
        """
        kwargs["_return_http_data_only"] = True
        return await self.update_with_http_info(communication_id, simple_public_object_input, **kwargs)  # noqa: E501

    async def update_with_http_info(self, communication_id, simple_public_object_input, **kwargs):  # noqa: E501
        """Update  # noqa: E501
        ...
        all_params = ["communication_id", "simple_public_object_input", "id_property"]
        all_params.extend(["async_req", "_return_http_data_only", "_preload_content", "_request_timeout", "_request_auth", "_content_type", "_headers"])
        ...
        # verify the required parameter 'communication_id' is set
        if self.api_client.client_side_validation and local_var_params.get("communication_id") is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `communication_id` when calling `update`")  # noqa: E501
