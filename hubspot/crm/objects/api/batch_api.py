...
class BatchApi(object):
    ...
    async def read_with_http_info(self, object_type, batch_read_input_simple_public_object_id, **kwargs):  # noqa: E501
        ...
        all_params = ["object_type", "batch_read_input_simple_public_object_id", "archived"]
        all_params.extend(["async_req", "_return_http_data_only", "_preload_content", "_request_timeout", "_request_auth", "_content_type", "_headers"])
    ...
    async def upsert(self, object_type, batch_input_simple_public_object_batch_input_upsert, **kwargs):  # noqa: E501
        ...
        >>> thread = api.upsert(object_type, batch_input_simple_public_object_batch_input_upsert, async_req=True)
        >>> result = thread.get()
    ...
    async def upsert_with_http_info(self, object_type, batch_input_simple_public_object_batch_input_upsert, **kwargs):  # noqa: E501
        ...
        >>> thread = api.upsert_with_http_info(object_type, batch_input_simple_public_object_batch_input_upsert, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ["object_type", "batch_input_simple_public_object_batch_input_upsert"]
        all_params.extend(["async_req", "_return_http_data_only", "_preload_content", "_request_timeout", "_request_auth", "_content_type", "_headers"])
        ...
        # verify the required parameter 'object_type' is set
        if self.api_client.client_side_validation and local_var_params.get("object_type") is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `object_type` when calling `upsert`")  # noqa: E501
