...
from hubspot.crm.objects.taxes.exceptions import ApiTypeError, ApiValueError  # noqa: F401
...
class BasicApi(object):
    ...
    async def archive(self, tax_id, **kwargs):  # noqa: E501
        """Archive  # noqa: E501

        Move an Object identified by `{taxId}` to the recycling bin.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.archive(tax_id, async_req=True)
        >>> result = thread.get()
        ...
        return await self.archive_with_http_info(tax_id, **kwargs)  # noqa: E501

    async def archive_with_http_info(self, tax_id, **kwargs):  # noqa: E501
        """Archive  # noqa: E501
        ...
        >>> thread = api.archive_with_http_info(tax_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and local_var_params.get("tax_id") is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `tax_id` when calling `archive`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if "tax_id" in local_var_params:
            path_params["taxId"] = local_var_params["tax_id"]  # noqa: E501
    ...
    async def create(self, simple_public_object_input_for_create, **kwargs):  # noqa: E501
        ...
        Create a tax with the given properties and return a copy of the object, including the ID. Documentation and examples for creating standard taxes is provided.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    async def get_by_id(self, tax_id, **kwargs):  # noqa: E501
        """Read  # noqa: E501

        Read an Object identified by `{taxId}`. `{taxId}` refers to the internal object ID by default, or optionally any unique property value as specified by the `idProperty` query param.  Control what is returned via the `properties` query param.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_by_id(tax_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs["_return_http_data_only"] = True
        return await self.get_by_id_with_http_info(tax_id, **kwargs)  # noqa: E501

    async def get_by_id_with_http_info(self, tax_id, **kwargs):  # noqa: E501
        """Read  # noqa: E501
        ...
        >>> thread = api.get_by_id_with_http_info(tax_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ["tax_id", "properties", "properties_with_history", "associations", "archived", "id_property"]
        all_params.extend(["async_req", "_return_http_data_only", "_preload_content", "_request_timeout", "_request_auth", "_content_type", "_headers"])
        ...
        # verify the required parameter 'tax_id' is set
        if self.api_client.client_side_validation and local_var_params.get("tax_id") is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `tax_id` when calling `get_by_id`")  # noqa: E501
    ...
    async def get_page(self, **kwargs):  # noqa: E501
        ...
        Read a page of taxes. Control what is returned via the `properties` query param.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    async def update(self, tax_id, simple_public_object_input, **kwargs):  # noqa: E501
        """Update  # noqa: E501
        ...
        >>> thread = api.update(tax_id, simple_public_object_input, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs["_return_http_data_only"] = True
        return await self.update_with_http_info(tax_id, simple_public_object_input, **kwargs)  # noqa: E501

    async def update_with_http_info(self, tax_id, simple_public_object_input, **kwargs):  # noqa: E501
        """Update  # noqa: E501
        ...
        >>> thread = api.update_with_http_info(tax_id, simple_public_object_input, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ["tax_id", "simple_public_object_input", "id_property"]
        all_params.extend(["async_req", "_return_http_data_only", "_preload_content", "_request_timeout", "_request_auth", "_content_type", "_headers"])
        ...
        # verify the required parameter 'tax_id' is set
        if self.api_client.client_side_validation and local_var_params.get("tax_id") is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `tax_id` when calling `update`")  # noqa: E501
